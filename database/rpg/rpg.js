const fs = require('fs')
const uang = JSON.parse(fs.readFileSync('./database/rpg/uang.json'))
const ikan = JSON.parse(fs.readFileSync('./database/rpg/ikan.json'))
const planet = JSON.parse(fs.readFileSync('./database/rpg/planet.json'))
const coal = JSON.parse(fs.readFileSync('./database/rpg/coal.json'))
const stone = JSON.parse(fs.readFileSync('./database/rpg/stone.json'))
const ore = JSON.parse(fs.readFileSync('./database/rpg/ore.json'))
const ingot = JSON.parse(fs.readFileSync('./database/rpg/ingot.json'))
const kayu = JSON.parse(fs.readFileSync('./database/rpg/kayu.json'))
const _level = JSON.parse(fs.readFileSync('./database/rpg/level.json'))
let besiAwal = 15;
  let goldAwal = 10;
  let emeraldAwal = 5;
  let umpanAwal = 5;
...
let _RPG = JSON.parse(fs.readFileSync('./database/rpg/inventory.json'))
...
const addLevelingXp = (sender, amount) => {
	...
	if (position !== false) {
		...
		fs.writeFileSync('./database/rpg/level.json', JSON.stringify(_level))
	}
}
...
const addATM = (sender) => {
	...
	uang.push(objo)
	fs.writeFileSync('./database/rpg/uang.json', JSON.stringify(uang))
}
...
const addIkan = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/ikan.json', JSON.stringify(ikan))
    	}
    }
...
const addPlanet = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/planet.json', JSON.stringify(planet))
    	}
    }
...
const jualbahankimia = (sender, amount) => {
 ...
 const addCoal = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/coal.json', JSON.stringify(coal))
    	}
    }
...
const addStone = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/stone.json', JSON.stringify(stone))
    	}
    }
...
const addOre = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/ore.json', JSON.stringify(ore))
    	}
    }
...
const jualore = (sender, amount) => {
        ...
        if (position !== false) {
            ore[position].copperore -= amount
            fs.writeFileSync('./database/rpg/ingot.json', JSON.stringify(ingot))
        }
    }
...
const addKayu = (sender, amount) => {
    	...
    	fs.writeFileSync('./database/rpg/kayu.json', JSON.stringify(kayu))
    	}
    }
...
const addInventori = (sender) => {
            ...
            _RPG.push(obj)
            fs.writeFileSync('./database/rpg/inventory.json', JSON.stringify(_RPG))
        } 
